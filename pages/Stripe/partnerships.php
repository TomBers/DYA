...
$customer = Stripe_Customer::create(array(
	...
	$customer->subscriptions->create(array("plan" => "partnership"));
	...
	$updateCustomer = "UPDATE users SET `account`='PART',`paymentId`='$customer->id',`paymentEmail`='$paymentEmail'  WHERE `id`='$uid'";
	...
	echo '<h1>Successfully subscribed to the Events package</h1>';
	?>