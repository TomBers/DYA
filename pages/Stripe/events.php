...
$customer = Stripe_Customer::create(array(
	...
	$customer->subscriptions->create(array("plan" => "events"));
	...
	$updateCustomer = "UPDATE users SET `account`='EVNT',`paymentId`='$customer->id',`paymentEmail`='$paymentEmail'  WHERE `id`='$uid'";
