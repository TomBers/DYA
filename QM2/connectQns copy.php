...
<div class="container">
	...
	function dealWithListMovement(qnID){
				...
				var listAdd='<li id="'+qnID+'"><span class="code">'+code+'</span> <span class="qn">'+qn+'</span> <span class="group">'+gp+'</span><div class="remove" id='+code+'>X</div></li>'; 
				...
				$('.remove').unbind('click').click(function(){
					...
					var bakToList ='<tr id=\"'+code+'\"><td>'+code+'</td><td>'+qn+'</td><td>'+gp+'</td><td><a href="cQn.php?edit='+code+'">Edit</a></td><td><input type="button" id="'+code+'" class="addBtn" value=">"></tr>';
