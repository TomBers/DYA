...
if(!isset($_SESSION['DYA_id'])){
	header('Location:https://www.doyouagree.co.uk/SLogin.php?redirect=https://www.doyouagree.co.uk/pages/stripe/payment.php');
}
?>
...
<div id="fdw-pricing-table">
    <div class="plan plan1">
        ...
        <ul>
            <li><b>Limited</b> questions</li>
            <li><b>Brand</b> all questions</li>
            <li><b>Dashboard</b> for results</li>
			<li><b>Download</b> part of your data</li>			
        </ul>
        <a class="signup" href="https://www.doyouagree.co.uk/SLogin.php">Sign up</a>         
    </div>
 <div class="plan plan3">
        <div class="hdr">Follow ups</div>
        <div class="price">£50</div>
        <div class="monthly">per month</div>
        <ul>
            <li><b>Follow up</b> with delegates</li>
            <li><b>Combine</b> quizzes/feedback</li>
            <li><b>Unlimited</b> surveys</li>
			<li>E-mail<b> support</b> </li>			
        </ul>
        	<form action="stripe/followup.php" method="post">	
				<script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
						  ...
						  data-currency="gbp"
						  data-name="Follow up Package"></script>
		</form>        
    </div>
    <div class="plan plan2 popular-plan">
        <div class="hdr">Events</div>
        ...
        <ul>
			...
			<li><b>LiveView</b> realtime view</li>			
        </ul>
        	<form action="stripe/events.php" method="post">	
				<script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
						  ...
						  data-description="Subscription"
						  data-currency="gbp"
						  data-name="Events Package"></script>
		</form>           
    </div>
			...
			<li><b>Full consultation</b> </li>			
          	...
          	<form action="stripe/partnerships.php" method="post">	
				<script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
						  ...
						  data-description="Subscription"
						  data-currency="gbp"
						  data-name="Partnership Package"></script>
		</form>      
    </div> 	
</div>
	</hdr><!-- end hdr -->
